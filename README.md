...
Aqui também você vai observar que o usuário via digitar 1 número inteiros "N", esse número será a quantidade de linhas a ser mostrado;
A partir desse numero o programa vai mostrar na tela a segunte brincadeira: 1 2 3 PUM,  depois na próxima linha 4 5 6 PUM, assim sucessivamente;
